  ...
  },
  {
    ...
    tokens: [
      ...
      },
      {
        ...
        sampleClassName: 'text-brand-accent-foreground',
      },
      {
        label: 'brand-accent-foreground',
        varName: '--brand-accent-foreground',
        className: 'bg-brand-accent-foreground',
        sampleClassName: 'text-brand-accent',
      },
      {
        label: 'brand-accent-bg',
        varName: '--brand-accent-bg',
        className: 'bg-brand-accent-bg',
        sampleClassName: 'text-brand-accent',
      },
    ],
  },
...
export const unmappedTokens: UnmappedToken[] = [
  ...
  {
    token: '--brand-accent-fg (on-brand-accent-subtle text)',
    reason:
      'Present in the States & Components page (#0369A1 light / #7DD3FC dark) but absent from tokens/colors.css. No brand-accent-subtle-foreground token exists in the CSS layer — text on brand-accent-bg has no dedicated color.',
  },
]
