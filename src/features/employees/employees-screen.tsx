 ...
 * there). Row actions / bulk ops / selection are gated by role via
 * `permitActions` — on for HR/Admin, off for view-only roles (read-only roster).
 * ------------------------------------------------------------------------- */
...
export function EmployeesScreen() {
  const role = useRole()
  // HR/Admin manage the roster; other roles get a read-only view (design:
